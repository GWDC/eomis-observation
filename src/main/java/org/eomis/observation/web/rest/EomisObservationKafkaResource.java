...
@RestController
@RequestMapping("/api/eomis-observation-kafka")
public class EomisObservationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EomisObservationKafkaResource.class);
    ...
    public EomisObservationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
